...
const ConfirmPaymentCard = ({ route }) => {
        ...
        <View style={tw`flex-1 bg-white p-6 w-full`}>
          <Grid style={tw`pt-1`}>
            <Col size={2}>
              ...
              <Text style={tw`text-gray-700 text-2xl font-bold tracking-tighter mb-3`}>{route?.params?.currentRate}</Text>
          ...
          <TouchableOpacity onPress={() => navigation.navigate("PickupCard", { ...route?.params })} style={tw`bg-black mt-auto py-2`}>
